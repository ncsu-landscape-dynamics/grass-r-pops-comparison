...
r.import "data/t10x10/host.tif" output=host
r.import "data/t10x10/all_plants.tif" output=all_plants
r.import "data/t10x10/initial_infections_single.tif" output=initial_infections_single
r.import "data/t10x10/weather_0dot50.tif" output=weather_0dot50
r.import "data/t10x10/weather_1.tif" output=weather_1
