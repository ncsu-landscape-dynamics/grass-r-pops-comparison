...
data <- pops_multiple(
    ...
    temperature_file="",
    temperature_coefficient_file="data/t100x100/weather_0dot50.tif",
    precipitation_coefficient_file="data/t100x100/weather_1.tif",
...
dir.create("/outputs/data/output_t100x100", recursive = TRUE)
writeRaster(raster(probability), "/outputs/data/output_t100x100/probability.tif", "GTiff", options=c('TFW=YES'), overwrite=TRUE)
